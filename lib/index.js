...
var useVisibiltyPerctange = function useVisibiltyPerctange() {
  ...
  var scrollHandler = (0, _react.useCallback)((0, _lodash["default"])(function () {
    var _getPercentageAndPosi = getPercentageAndPosition(ref, window, offsetTop, offsetBottom),
        _getPercentageAndPosi2 = _slicedToArray(_getPercentageAndPosi, 2),
        nextPercentage = _getPercentageAndPosi2[0],
        nextPosition = _getPercentageAndPosi2[1];

    var _percentageAndPositio = _slicedToArray(percentageAndPosition, 1),
        currentPrecentage = _percentageAndPositio[0]; //rerender only if percentage has changed
